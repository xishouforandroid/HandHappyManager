    ...
    var N = function (h) {
        ...
        function R(a) {
            ...
            for (a = 0; a < n.length; a++) {
                ...
                f = e[i].aDataSort;
                b = 0;
                for (c = f.length; b < c; b++)g = f[b], j = e[g].sType || "string", n[a]._idx === l && (n[a]._idx = h.inArray(n[a][1], e[g].asSorting)), d.push({
                    src: i,
                    col: g,
                    dir: n[a][1],
                    index: n[a]._idx,
        ...
        function kb(a) {
            ...
            h = R(a);
            b = 0;
            for (c = h.length; b < c; b++)j = h[b], j.formatter && g++, Hb(a,
                j.col);
        ...
        function Ka(a, b, c, d) {
            ...
            Ta(b, {}, function (b) {
                !1 !==
                e.bSortable && (a.oFeatures.bProcessing ? (B(a, !0), setTimeout(function () {
                    Sa(a, c, b.shiftKey, d);
                    "ssp" !== z(a) && B(a, !1)
        ...
        function Hb(a, b) {
            var c = a.aoColumns[b], d = p.ext.order[c.sSortDataType],
                e;
                ...
                jqueryui: function (a, b, c, d) {
                    ...
                    h(a.nTable).on("order.dt.DT", function (f, g, h, i) {
                        if (a === g) {
                            ...
                            b.find("span." + d.sSortIcon).removeClass(d.sSortJUIAsc + " " + d.sSortJUIDesc + " " + d.sSortJUI + " " + d.sSortJUIAscAllowed + " " + d.sSortJUIDescAllowed).addClass(i[e] ==
                            "asc" ? d.sSortJUIAsc : i[e] == "desc" ? d.sSortJUIDesc : c.sSortingClassJUI)
                        }
                    })
                }
            }
